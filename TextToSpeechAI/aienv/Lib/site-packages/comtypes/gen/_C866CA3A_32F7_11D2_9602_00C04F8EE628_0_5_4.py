...
__all__ = [
    'DISPID_SMSGetData', 'SSSPTRelativeToStart',
    'SAFT48kHz8BitStereo', 'SpeechCategoryAudioOut', 'SLTApp',
    'DISPID_SGRSAddRuleTransition', 'ISpeechObjectToken',
    'SDTPronunciation', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SVSInputSentenceLength', 'DISPID_SGRSTWeight',
    'ISpeechGrammarRules', 'SP_VISEME_12',
    'SAFTCCITT_uLaw_22kHzStereo', 'SRAONone', 'SVEBookmark',
    'SSTTTextBuffer', 'DISPID_SPEEngineConfidence',
    'DISPID_SRRGetXMLResult', 'DISPID_SRRecognizer',
    'SAFT12kHz16BitStereo', 'eLEXTYPE_PRIVATE6',
    'DISPID_SVSRunningState', 'SpStream', 'SPSHORTCUTPAIR',
    'SPRS_INACTIVE', 'eLEXTYPE_RESERVED7', 'SpeechGrammarState',
    'SAFTCCITT_ALaw_11kHzStereo', 'SRARoot', 'SP_VISEME_2',
    'SPRECOSTATE', 'SSFMCreateForWrite', 'DISPID_SPCIdToPhone',
    'SpeechRecoProfileProperties', 'DISPID_SPRulesItem',
    'ISpStreamFormat', 'DISPID_SPRuleParent', 'SASRun', 'SPBO_AHEAD',
    'SPEI_RESERVED6', 'SPEI_RESERVED2', 'SPEI_HYPOTHESIS',
    'DISPIDSPTSI', 'SpeechBookmarkOptions', 'SPSERIALIZEDPHRASE',
    'SRSActive', 'SGLexicalNoSpecialChars', 'SGSExclusive',
    'SVSFIsNotXML', 'DISPID_SRCEInterference',
    'SGDSActiveUserDelimited', 'ISpeechWaveFormatEx',
    'DISPID_SPRulesCount', 'SAFTADPCM_8kHzStereo', 'SRCS_Enabled',
    'ISpeechLexiconWords', 'ISpeechRecoResultTimes',
    'DISPID_SRGDictationLoad', 'DISPID_SPEDisplayAttributes',
    'SPEI_SR_PRIVATE', 'SpSharedRecognizer', 'DISPID_SRGRules',
    'ISpObjectTokenCategory', 'SINoise', 'SWPKnownWordPronounceable',
    'DISPID_SpeechRecognizer', 'DISPID_SOTId', 'SAFT8kHz8BitStereo',
    'SP_VISEME_20', 'DISPID_SADefaultFormat', 'DISPID_SDKDeleteValue',
    'SDA_One_Trailing_Space', 'ISpeechPhraseReplacements',
    'DISPID_SVAudioOutput', 'ISpeechAudio', 'SGRSTTRule',
    'Speech_StreamPos_Asap', 'SPCT_COMMAND',
    'SpeechGrammarTagWildcard', 'SP_VISEME_10',
    'DISPID_SRCEAdaptation', 'SpeechAudioFormatGUIDWave',
    'SPVPRI_OVER', 'SpeechTokenValueCLSID', 'DISPID_SVVoice',
    'SRSEIsSpeaking', 'SPAR_Unknown',
    'DISPID_SpeechLexiconPronunciation', 'eWORDTYPE_ADDED',
    'DISPID_SOTDataKey', 'SAFTADPCM_44kHzStereo',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPEI_RESERVED5',
    'ISpeechPhraseInfo', 'ISpObjectToken', 'SAFTADPCM_22kHzStereo',
    'SPVOICESTATUS', 'SAFT24kHz8BitMono', 'SVSFVoiceMask',
    'DISPID_SPILanguageId', 'WAVEFORMATEX', 'SPEI_TTS_AUDIO_LEVEL',
    'SPPS_NotOverriden', 'SGLexical', 'SPPARTOFSPEECH', 'SRTReSent',
    'DISPID_SPIRetainedSizeBytes', 'ISpXMLRecoResult',
    'DISPID_SRGCmdSetRuleIdState', 'eLEXTYPE_PRIVATE17',
    'DISPID_SVEVoiceChange', 'SREInterference', 'SpAudioFormat',
    'IInternetSecurityManager', 'SPRST_ACTIVE', 'SRTSMLTimeout',
    'SPAR_High', 'DISPID_SOTGetDescription', 'DISPID_SLPsCount',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'eLEXTYPE_LETTERTOSOUND',
    'SPAUDIOSTATUS', 'DISPID_SVAudioOutputStream',
    'SAFTCCITT_ALaw_22kHzMono', 'SAFTExtendedAudioFormat',
    'SAFTADPCM_11kHzMono', 'SRSInactive', 'SAFT8kHz8BitMono',
    'SGDSActive', 'SPSModifier', 'SP_VISEME_11',
    'SpeechEngineConfidence', 'SDTReplacement',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVVolume',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechRuleAttributes', 'SPRST_NUM_STATES',
    'DISPID_SWFEAvgBytesPerSec', 'DISPIDSPTSI_ActiveLength',
    'SAFT44kHz8BitStereo', 'DISPID_SVSVisemeId', 'SPSHT_Unknown',
    'SDA_Consume_Leading_Spaces', 'SAFTText',
    'DISPID_SPRFirstElement', 'SAFT24kHz16BitStereo',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVGetAudioOutputs',
    'DISPID_SDKEnumKeys', 'SPWT_PRONUNCIATION', 'SAFT32kHz8BitStereo',
    'SGSEnabled', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SBSWrite', 'DISPID_SGRId', 'DISPID_SABIMinNotification',
    'DISPID_SRCEEndStream', 'SPGS_ENABLED', 'ISpNotifySink',
    'DISPID_SMSALineId', 'SPPHRASE', 'eLEXTYPE_PRIVATE18',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SAFTCCITT_ALaw_44kHzMono', 'ISpRecoCategory', 'DISPID_SLWWord',
    'SVP_4', 'SpeechDisplayAttributes', 'DISPID_SABufferInfo',
    'SREPrivate', 'SPINTERFERENCE_TOOLOUD', 'DISPID_SRGetFormat',
    'SSSPTRelativeToCurrentPosition', 'ISpeechPhraseReplacement',
    'DISPID_SDKSetStringValue', 'DISPID_SBSFormat', 'SREStreamEnd',
    'ISpRecoGrammar', 'DISPID_SpeechPhraseInfo',
    'SpeechAddRemoveWord', 'SITooQuiet', 'DISPID_SpeechLexiconWords',
    'DISPID_SOTRemove', 'SpResourceManager', 'SPCATEGORYTYPE',
    'SPCS_ENABLED', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRStatus', 'DISPID_SOTCId', 'SAFTGSM610_11kHzMono',
    'DISPID_SpeechPhraseRule', 'SVEAllEvents',
    'DISPID_SpeechObjectTokens',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPEI_TTS_BOOKMARK',
    'SPAR_Medium', 'DISPID_SRCERecognitionForOtherContext',
    'SGPronounciation', 'DISPID_SRCERecognizerStateChange',
    'ISpeechPhraseElements', 'SP_VISEME_19',
    'DISPID_SVSInputWordPosition', 'SSFMCreate', 'DISPID_SAStatus',
    'DISPID_SRGSetTextSelection', 'DISPID_SOTMatchesAttributes',
    'SP_VISEME_7', 'SP_VISEME_18', 'SAFT44kHz8BitMono',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpeechObjectTokens',
    'SpeechRegistryUserRoot', 'DISPID_SRCEPhraseStart',
    'SREFalseRecognition', 'DISPID_SPIAudioStreamPosition',
    'SpTextSelectionInformation', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SDKGetStringValue', 'SpeechPropertyResponseSpeed',
    'DISPID_SPAsItem', 'SECHighConfidence', 'SPVPRI_ALERT',
    'SPLO_STATIC', 'ISpeechVoice', 'DISPID_SRSetPropertyNumber',
    'SpeechCategoryAudioIn', 'ISpEventSink',
    'SAFTCCITT_uLaw_22kHzMono', 'STCAll',
    'SpeechDictationTopicSpelling', 'DISPID_SVEBookmark',
    'SVEStartInputStream', 'ISpeechPhraseProperty', 'SVP_15',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SVSpeak',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SVGetAudioInputs', 'SITooLoud',
    'DISPID_SRCRetainedAudio', 'SPPHRASEELEMENT', 'SPEI_MAX_TTS',
    'DISPID_SLPPartOfSpeech', 'DISPID_SPCLangId',
    'DISPID_SPRs_NewEnum', 'DISPID_SDKSetLongValue',
    'DISPID_SRCCreateResultFromMemory', 'SVEPhoneme', 'UINT_PTR',
    'DISPID_SVSLastBookmark', 'SWPUnknownWordUnpronounceable',
    'SpeechGrammarTagUnlimitedDictation', 'ISpRecognizer',
    '_ISpeechVoiceEvents', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SPSTREAMFORMATTYPE', 'DISPID_SpeechPhraseRules',
    'SpeechVoiceSpeakFlags', 'DISPID_SLGetGenerationChange',
    'SPSNoun', 'DISPID_SGRName', 'DISPID_SVESentenceBoundary',
    'SAFT11kHz16BitStereo', 'DISPID_SRGSetWordSequenceData',
    'Speech_StreamPos_RealTime', 'DISPID_SLPType', 'SGSDisabled',
    'DISPID_SABufferNotifySize', 'ISpRecoContext2',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SLWType', 'SPEI_MIN_SR',
    'DISPID_SPIStartTime', 'SECFEmulateResult', 'SVEVoiceChange',
    'DISPID_SOTIsUISupported', 'SRAInterpreter', 'SGRSTTDictation',
    '__MIDL_IWinTypes_0009', 'DISPID_SRCEFalseRecognition',
    'DISPID_SOTGetAttribute', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRCERequestUI', 'SRTAutopause', 'ISpObjectWithToken',
    'DISPID_SWFEExtraData', 'DISPID_SPAsCount', 'DISPID_SPIEngineId',
    'DISPID_SVEPhoneme', 'ISpeechLexiconWord', 'SPSInterjection',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'eLEXTYPE_APP',
    'SPEI_END_INPUT_STREAM', 'SpeechAudioVolume',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SVResume',
    'DISPID_SGRSTPropertyName', 'SVP_17', 'SVP_14',
    'DISPID_SDKGetlongValue', 'DISPID_SPEAudioStreamOffset',
    'SREAudioLevel', 'SITooFast', 'SPDKL_CurrentConfig',
    'DISPID_SRIsUISupported', 'STCInprocHandler', 'DISPID_SPRText',
    'DISPID_SPRuleConfidence', 'ISpeechRecoResult',
    'ISpeechPhraseAlternates', 'SPEI_SOUND_END',
    'DISPID_SPRules_NewEnum', 'ISpeechGrammarRuleStateTransition',
    'ISpeechBaseStream', 'SPINTERFERENCE_NOISE',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRCEBookmark',
    'ISequentialStream', 'ISpProperties', 'DISPID_SpeechFileStream',
    'DISPID_SPISaveToMemory', 'SAFTADPCM_8kHzMono', 'DISPID_SRRAudio',
    'SRERecognition', 'SREStateChange',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpeechObjectTokenCategory', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SLPSymbolic', 'ISpRecoGrammar2', 'DISPID_SGRSTPropertyId',
    'SPWORDLIST', 'SVSFDefault', 'SpeechTokenShellFolder',
    'SpeechLoadOption', 'DISPID_SpeechMemoryStream',
    'DISPID_SGRSTsItem', 'SREHypothesis', 'SpMMAudioIn',
    'SpInprocRecognizer', 'SGRSTTWildcard', 'DISPID_SVStatus',
    'DISPID_SGRs_NewEnum', 'DISPID_SRSCurrentStreamNumber',
    'ISpNotifyTranslator', 'SPAR_Low', 'DISPID_SMSAMMHandle',
    'SECFIgnoreWidth', 'SpShortcut', 'SVSFIsXML',
    'DISPID_SASNonBlockingIO', 'DISPID_SGRSAddWordTransition',
    'DISPID_SRGetPropertyNumber', 'ISpPhoneConverter',
    'eWORDTYPE_DELETED', 'SLTUser', 'SpeechCategoryRecognizers',
    'SVP_0', 'DISPID_SpeechAudio', 'ISpeechRecoResultDispatch',
    'DISPID_SGRsAdd', 'DISPID_SPIGrammarId',
    'SGDSActiveWithAutoPause', 'DISPID_SPAStartElementInResult',
    'SPEI_END_SR_STREAM', 'SP_VISEME_4', 'SVP_18', 'SPEI_RECOGNITION',
    'SDKLLocalMachine', 'SPGS_DISABLED', 'DISPID_SPRsCount',
    'DISPID_SPPChildren', 'DISPID_SRCCmdMaxAlternates', 'SBOPause',
    'DISPID_SGRsFindRule', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SVEEnginePrivate', 'SVSFParseSapi', 'SPSEMANTICERRORINFO',
    'SRTStandard', 'DISPID_SOTCreateInstance', 'DISPID_SPEsItem',
    'DISPID_SRCRequestedUIType', 'DISPID_SpeechLexiconWord',
    'DISPID_SRSSupportedLanguages', 'DISPID_SVAlertBoundary',
    'SPCONTEXTSTATE', 'DISPID_SDKEnumValues', 'DISPID_SLPPhoneIds',
    'SAFT22kHz16BitStereo', 'IEnumString',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SGRAddState',
    'SPEVENTENUM', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechVoiceStatus', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpeechAudioBufferInfo', 'DISPID_SFSOpen', 'SAFT44kHz16BitMono',
    'SAFTADPCM_11kHzStereo', 'SPEI_PHRASE_START',
    'SPADAPTATIONRELEVANCE', 'SREAdaptation', 'ISpStream',
    'DISPID_SREmulateRecognition', 'eLEXTYPE_PRIVATE16',
    'DISPID_SDKDeleteKey', 'SPWORDPRONOUNCEABLE',
    'DISPID_SPIElements', 'SpCompressedLexicon',
    'ISpeechResourceLoader', 'DISPID_SPIAudioSizeBytes',
    'SPRST_INACTIVE_WITH_PURGE', 'SpObjectTokenCategory',
    'DISPID_SRCEEnginePrivate', 'SpeechRecoEvents',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRCERecognition',
    'SPPHRASEREPLACEMENT', 'DISPID_SVEWord', 'SASPause',
    'SPPS_RESERVED2', 'SpeechVisemeType', 'SPEI_MAX_SR',
    'DISPID_SLGenerationId', 'DISPID_SRGState', 'SAFT32kHz8BitMono',
    'SLODynamic', 'Speech_Default_Weight',
    'DISPID_SRGCmdLoadFromMemory', 'eLEXTYPE_PRIVATE3',
    'SDA_Two_Trailing_Spaces', 'DISPID_SpeechPhraseReplacements',
    'SPEI_START_INPUT_STREAM', 'DISPID_SpeechRecoResultTimes',
    'SVP_5', 'SpeechGrammarTagDictation', 'eLEXTYPE_PRIVATE19',
    'SVF_Emphasis', 'SpeechEmulationCompareFlags', 'SGRSTTEpsilon',
    'DISPID_SPERequiredConfidence', 'DISPID_SLWs_NewEnum',
    'SpUnCompressedLexicon', 'DISPID_SOTCDefault',
    'DISPID_SPRNumberOfElements', 'DISPID_SPPConfidence', 'IStream',
    'SAFTADPCM_22kHzMono', 'DISPID_SpeechRecognizerStatus',
    'Speech_Max_Pron_Length', 'DISPID_SPCPhoneToId',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpeechGrammarRule', 'SVP_11',
    'ISpAudio', 'SPSMF_UPS', 'DISPID_SPELexicalForm',
    'DISPID_SAEventHandle', 'DISPID_SpeechPhraseBuilder',
    'SPEI_RESERVED1', 'SRTExtendableParse', 'eLEXTYPE_RESERVED6',
    'SPCT_DICTATION', 'DISPID_SRCESoundStart', 'SPFM_NUM_MODES',
    'SpeechAudioFormatGUIDText', 'SAFT24kHz16BitMono',
    'eLEXTYPE_PRIVATE1', 'SAFT16kHz8BitStereo', 'SPEI_TTS_PRIVATE',
    'SP_VISEME_9', 'SVP_9', 'SECFIgnoreCase', 'DISPID_SBSRead',
    'DISPID_SVPriority', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRCCreateGrammar', 'SPAS_PAUSE', 'eLEXTYPE_RESERVED10',
    'DISPID_SVEStreamEnd', 'SRSInactiveWithPurge',
    'SpeechCategoryVoices', 'DISPID_SPEs_NewEnum',
    'ISpeechGrammarRuleState', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SOTs_NewEnum', 'SpeechWordType',
    'DISPID_SPPEngineConfidence', 'DISPID_SGRSRule',
    'ISpStreamFormatConverter', 'eLEXTYPE_PRIVATE11',
    'SPFM_CREATE_ALWAYS', 'SpObjectToken', 'DISPID_SRRPhraseInfo',
    'DISPID_SPPsItem', 'DISPID_SPEsCount', 'DISPID_SWFEFormatTag',
    'SP_VISEME_5', 'SVSFParseAutodetect', 'SAFTGSM610_22kHzMono',
    'SPXRO_SML', 'DISPID_SVEStreamStart', 'SPCT_SLEEP',
    'SAFTGSM610_44kHzMono', 'ISpeechTextSelectionInformation',
    'SPEVENT', 'ISpeechPhraseAlternate', 'SVSFlagsAsync',
    'SPEI_REQUEST_UI', 'DISPID_SGRAddResource', 'ISpMMSysAudio',
    'ISpSerializeState', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRCBookmark', 'DISPID_SpeechAudioStatus',
    'SAFTCCITT_ALaw_8kHzMono', 'SpeechRetainedAudioOptions',
    'DISPIDSPRG', 'SVP_8', 'SRTEmulated', 'ISpVoice',
    'DISPID_SGRSTType', 'DISPID_SRRSaveToMemory', 'SPEI_INTERFERENCE',
    'DISPID_SWFEBitsPerSample', 'DISPID_SFSClose', 'SAFTDefault',
    'SREPropertyNumChange', 'DISPID_SPEActualConfidence',
    'DISPIDSPTSI_ActiveOffset', 'SAFTNoAssignedFormat',
    'SSTTDictation', 'SPWORD', 'SPPS_Interjection',
    'SPGRAMMARWORDTYPE', 'SVSFIsFilename', 'STSF_AppData',
    'SPEI_UNDEFINED', 'DISPID_SGRSTNextState', 'DISPID_SVEViseme',
    'ISpeechRecoGrammar', 'SP_VISEME_1', 'DISPID_SVSpeakStream',
    'DISPID_SLWsCount', 'SRERequestUI', 'SAFT8kHz16BitStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPSEMANTICFORMAT',
    'SAFT44kHz16BitStereo', 'DISPID_SRRSpeakAudio',
    'SpeechCategoryPhoneConverters', 'SREBookmark',
    'STSF_CommonAppData', 'SVP_13', 'SVP_6', 'SpMMAudioEnum',
    'DISPID_SLAddPronunciation', 'DISPID_SPERetainedSizeBytes',
    'SDKLCurrentConfig', 'SpeechPropertyComplexResponseSpeed',
    'SPSHORTCUTTYPE', 'SpStreamFormatConverter', 'SVP_1',
    'SpeechRecognitionType', 'SAFT48kHz16BitMono',
    'DISPID_SCSBaseStream', 'DISPID_SRCEStartStream',
    'DISPID_SpeechPhraseElements', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SGRsCount', 'DISPID_SDKOpenKey', 'DISPID_SVGetProfiles',
    'ISpeechPhraseRules', 'DISPID_SAVolume',
    'SpeechWordPronounceable', 'DISPID_SPEPronunciation',
    'DISPID_SGRSTRule', 'SP_VISEME_17', 'DISPID_SOTCategory',
    '_SPAUDIOSTATE', 'DISPID_SpeechPhraseAlternates', 'SPVPRI_NORMAL',
    'DISPID_SRIsShared', 'SpeechRuleState', 'DISPID_SLGetWords',
    'SPPHRASEPROPERTY', 'DISPID_SLRemovePronunciation',
    'ISpeechDataKey', 'SPAS_RUN', 'SPEI_SR_RETAINEDAUDIO',
    'SECFDefault', 'SPSHT_NotOverriden',
    'DISPID_SPIGetDisplayAttributes', 'SPPHRASERULE',
    'DISPID_SPRuleName', 'DISPID_SLAddPronunciationByPhoneIds',
    'SAFT32kHz16BitStereo', 'SPTEXTSELECTIONINFO',
    'SpeechRecognizerState', 'DISPID_SGRsCommit',
    'DISPID_SpeechPhoneConverter', 'SRAImport',
    'DISPID_SOTGetStorageFileName', 'SPSHT_OTHER', 'SPWAVEFORMATTYPE',
    'SpCustomStream', 'DISPID_SLPs_NewEnum',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SpeechAudioFormat',
    'SAFT24kHz8BitStereo', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SWFEBlockAlign', 'DISPID_SVSkip', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SRCSetAdaptationData', 'DISPID_SpeechRecoResult',
    'SPAUDIOBUFFERINFO', 'DISPID_SpeechGrammarRules',
    'SGRSTTTextBuffer', 'DISPID_SRSCurrentStreamPosition', 'SVPOver',
    'eLEXTYPE_PRIVATE9', 'eLEXTYPE_PRIVATE15', 'SPSVerb',
    'DISPID_SPPsCount', 'SVP_3', 'eLEXTYPE_USER',
    'SpeechUserTraining', 'DISPID_SRCreateRecoContext',
    'DISPID_SRSAudioStatus', 'DISPID_SRSClsidEngine',
    'SPPS_SuppressWord', 'eLEXTYPE_PRIVATE14', 'ISpeechAudioStatus',
    'SPEI_MIN_TTS', 'SPEI_VOICE_CHANGE', 'DISPID_SLWsItem',
    'SpSharedRecoContext', 'SPEVENTSOURCEINFO', 'SPDKL_CurrentUser',
    'eLEXTYPE_RESERVED4', 'SPEI_RESERVED3',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SGRClear',
    'SSTTWildcard', 'DISPID_SpeechDataKey', 'SECNormalConfidence',
    'SPXMLRESULTOPTIONS', 'eLEXTYPE_PRIVATE5', 'SVPNormal',
    'SPINTERFERENCE', 'SPLO_DYNAMIC', 'SDA_No_Trailing_Space',
    'SpeechCategoryAppLexicons', 'ISpRecoContext',
    'DISPID_SVDisplayUI', 'SASStop', 'DISPID_SWFESamplesPerSec',
    'SpeechDataKeyLocation', 'SAFT22kHz8BitMono',
    'DISPID_SVSCurrentStreamNumber', 'ISpeechPhraseRule',
    'SVSFUnusedFlags', 'DISPID_SLPLangId', 'DISPID_SRGReset',
    'ISpPhoneticAlphabetSelection', 'SAFT11kHz8BitMono',
    'DISPID_SABIEventBias', 'SINoSignal', 'SVEViseme', 'SPRS_ACTIVE',
    'SAFTGSM610_8kHzMono', 'eLEXTYPE_RESERVED9', 'SREStreamStart',
    'SPPS_RESERVED4', 'DISPID_SRGId', 'SPSHORTCUTPAIRLIST',
    'ISpDataKey', 'DISPID_SpeechLexicon', 'SPAO_NONE',
    'ISpeechPhraseElement', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SMSADeviceId', 'DISPID_SPANumberOfElementsInResult',
    'SPRULE', 'ISpeechLexicon', 'STCInprocServer',
    'eLEXTYPE_RESERVED8', 'DISPID_SOTSetId',
    'DISPID_SpeechObjectTokenCategory', 'Speech_Max_Word_Length',
    'SDKLCurrentUser', 'DISPID_SDKGetBinaryValue',
    'SPXRO_Alternates_SML', 'SAFT48kHz16BitStereo',
    'SPEI_WORD_BOUNDARY', 'SPCT_SUB_DICTATION', 'SpeechTokenKeyFiles',
    'DISPID_SVIsUISupported', 'SVESentenceBoundary', 'LONG_PTR',
    'DISPID_SPIReplacements', 'DISPID_SRCESoundEnd', 'ISpPhraseAlt',
    'DISPID_SpeechPhraseProperties', 'SRATopLevel',
    'DISPID_SpeechBaseStream', 'STCLocalServer', 'SpeechInterference',
    'DISPID_SLGetPronunciations', 'SpeechVoiceEvents',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SPIRule',
    'ISpResourceManager', 'DISPID_SpeechPhraseElement', 'SVSFNLPMask',
    'SSFMOpenForRead', 'SAFT22kHz16BitMono',
    'DISPID_SVSInputWordLength', 'ISpEventSource',
    'DISPID_SLWPronunciations', 'SPAS_CLOSED', 'ISpeechRecognizer',
    'SpPhraseInfoBuilder', 'tagSTATSTG', 'DISPID_SRGCmdLoadFromFile',
    'SPBO_NONE', 'DISPID_SGRInitialState', 'DISPID_SRRTimes',
    'SP_VISEME_15', 'ISpeechMemoryStream', 'DISPID_SRState',
    'SpeechLexiconType', 'DISPID_SVSInputSentencePosition',
    'SPWF_INPUT', 'DISPID_SRCState', 'tagSPPROPERTYINFO',
    'DISPID_SOTCEnumerateTokens', 'ISpRecognizer2', 'SPVPRIORITY',
    'DISPID_SpeechPhraseAlternate', 'SGDSInactive',
    'DISPID_SRCEHypothesis', 'DISPID_SRGDictationUnload',
    'SRERecoOtherContext', 'SLOStatic', 'DISPID_SRRSetTextFeedback',
    'DISPID_SBSSeek', 'ISpRecoResult', 'DISPID_SpeechRecoResult2',
    'eLEXTYPE_MORPHOLOGY', 'SPSLMA', 'SAFT16kHz16BitStereo',
    'DISPID_SpeechCustomStream', 'ISpNotifySource',
    'ISpeechPhoneConverter', 'SDTAll', 'SPBOOKMARKOPTIONS',
    'SpPhoneConverter', 'DISPID_SPPName', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SGRSAddSpecialTransition', 'SpeechAudioProperties',
    'SPSERIALIZEDRESULT', 'DISPID_SVEventInterests', 'SGDisplay',
    'SVPAlert', 'DISPID_SpeechObjectToken', 'SECFIgnoreKanaType',
    'SVSFParseSsml', 'SVSFPersistXML', 'SPPS_Noncontent',
    'DISPID_SPPBRestorePhraseFromMemory', 'SFTInput',
    'DISPID_SRCEPropertyStringChange', 'SpWaveFormatEx',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPINTERFERENCE_TOOQUIET', 'SPPS_Modifier',
    'DISPID_SRCRecognizer', 'SSSPTRelativeToEnd',
    'SAFT32kHz16BitMono', 'SpMMAudioOut',
    'DISPID_SPRDisplayAttributes', 'DISPID_SVWaitUntilDone',
    'SpFileStream', 'SPPS_RESERVED1', 'SpeechPartOfSpeech',
    'DISPID_SRAudioInputStream', 'SAFTCCITT_ALaw_11kHzMono',
    'SPPS_Unknown', 'eLEXTYPE_PRIVATE4', 'ISpLexicon',
    'DISPID_SOTCSetId', 'DISPID_SPPs_NewEnum', 'SP_VISEME_0',
    'DISPID_SpeechGrammarRule', 'SPBO_PAUSE',
    'ISpeechLexiconPronunciations', 'DISPID_SASState',
    'SPAO_RETAIN_AUDIO', 'SP_VISEME_13', 'DISPID_SPACommit',
    'DISPID_SpeechPhraseReplacement', 'SpeechTokenKeyUI',
    'DISPID_SRRRecoContext', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SPIGetText',
    'SPEI_SR_BOOKMARK', 'SPGRAMMARSTATE', 'SPSSuppressWord',
    'DISPID_SPRuleNumberOfElements', 'ISpeechLexiconPronunciation',
    'ISpeechRecoResult2', 'SVP_10', 'SPWORDPRONUNCIATION', 'SRSEDone',
    'DISPID_SGRAttributes', 'SpeechTokenIdUserLexicon', 'SRAExport',
    'DISPID_SGRSTransitions', 'DISPID_SPRuleChildren',
    'SAFT11kHz8BitStereo', 'DISPID_SRGetPropertyString',
    'STSF_FlagCreate', 'SAFT16kHz16BitMono', 'SPGS_EXCLUSIVE',
    'DISPID_SABIBufferSize', 'DISPID_SRGIsPronounceable',
    'DISPID_SpeechPhraseProperty', 'DISPID_SOTDisplayUI',
    'SAFT48kHz8BitMono', 'DISPID_SVSLastStreamNumberQueued',
    'SpeechRunState', 'DISPID_SVSyncronousSpeakTimeout',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SGRSTText',
    'DISPID_SASFreeBufferSpace', 'SPWORDTYPE', 'SpNotifyTranslator',
    'SpeechStreamFileMode', 'DISPID_SGRsCommitAndSave',
    'DISPID_SpeechVoice', 'SWTDeleted', 'DISPID_SRCVoice',
    'DISPID_SRCEventInterests', 'SINone', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPPNumberOfElements', 'SpeechStreamSeekPositionType',
    'SVP_21', 'SRAORetainAudio', 'ISpeechPhraseProperties',
    'SPPS_RESERVED3', 'SpeechAudioFormatType', 'SpNullPhoneConverter',
    '_ISpeechRecoContextEvents', 'SAFT11kHz16BitMono', 'SREAllEvents',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SVRate', 'SVF_Stressed',
    'SREPhraseStart', 'SPEI_VISEME', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SDKCreateKey', 'DISPID_SGRsItem', 'SVP_12',
    'ISpeechPhraseInfoBuilder', 'DISPID_SVEAudioLevel',
    'SPEI_SOUND_START', 'SpeechRecoContextState', 'STSF_LocalAppData',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPFM_CREATE',
    'IEnumSpObjectTokens', 'SWTAdded', 'DISPID_SPIEnginePrivateData',
    'SPBO_TIME_UNITS', 'SAFTCCITT_ALaw_22kHzStereo',
    'ISpPhoneticAlphabetConverter', 'SSFMOpenReadWrite',
    'eLEXTYPE_VENDORLEXICON', 'SDTRule',
    'DISPID_SRGDictationSetState', 'SWPUnknownWordPronounceable',
    'DISPID_SPPParent', 'SPSHT_EMAIL', 'SPINTERFERENCE_TOOSLOW',
    'SpeechPropertyResourceUsage', 'SPPS_Verb', 'ISpeechMMSysAudio',
    'ISpShortcut', 'SPVISEMES', 'SFTSREngine', 'SVF_None',
    'DISPID_SDKSetBinaryValue', 'SDKLDefaultLocation', 'SPEI_PHONEME',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SGRsDynamic',
    'DISPID_SRRAudioFormat', 'SpeechVisemeFeature', 'SVP_7',
    'SPBINARYGRAMMAR', 'SpeechCategoryRecoProfiles',
    'DISPID_SPPFirstElement', 'SRADefaultToActive',
    'DISPID_SGRSTsCount', 'DISPID_SRAudioInput', 'SPAUDIOOPTIONS',
    'SpeechPropertyHighConfidenceThreshold', 'SPPROPERTYINFO',
    'ISpeechVoiceStatus', 'ISpeechFileStream', 'SPFM_OPEN_READONLY',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRRTStreamTime',
    'DISPID_SRCPause', 'DISPIDSPTSI_SelectionOffset',
    'SpPhoneticAlphabetConverter', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SVEEndInputStream', 'DISPID_SPRuleId', 'DISPID_SVPause',
    'SpeechTokenContext', 'SAFTCCITT_ALaw_8kHzStereo',
    'tagSPTEXTSELECTIONINFO', 'SVP_20', 'ISpeechCustomStream',
    'ISpGrammarBuilder', 'DISPID_SVSLastResult', 'ISpeechAudioFormat',
    'eLEXTYPE_PRIVATE12', 'DISPID_SpeechVoiceEvent',
    'DISPID_SLPsItem', 'SPFILEMODE', 'ISpPhrase', 'SpeechMicTraining',
    'SPRST_INACTIVE', 'SDTProperty', 'DISPID_SGRSTs_NewEnum',
    'IInternetSecurityMgrSite', 'SpeechVoicePriority',
    'SPLEXICONTYPE', 'SpInProcRecoContext',
    'DISPID_SVSLastBookmarkId', 'SPRECORESULTTIMES',
    'SRSActiveAlways', 'SPDATAKEYLOCATION', 'DISPID_SPIProperties',
    'SPEI_START_SR_STREAM', 'SpMemoryStream', 'eLEXTYPE_PRIVATE2',
    'SITooSlow', 'SpeechDiscardType', 'DISPID_SpeechRecoContext',
    'DISPID_SpeechMMSysAudio', 'DISPID_SRCEPropertyNumberChange',
    '_RemotableHandle', 'SPRECOCONTEXTSTATUS', 'SPCS_DISABLED',
    'DISPID_SAFType', 'SpVoice', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRRTLength', 'eLEXTYPE_PRIVATE8', 'DISPID_SRGCommit',
    'SpeechGrammarWordType', 'DISPID_SRRAlternates',
    'DISPID_SVSPhonemeId', 'DISPID_SRProfile', 'SBONone',
    'SPWT_DISPLAY', 'DISPID_SpeechXMLRecoResult', 'SPPS_Noun',
    'SAFT16kHz8BitMono', 'SP_VISEME_14', 'SRESoundStart',
    'DISPID_SRGRecoContext', 'SPCT_SUB_COMMAND', 'SPWT_LEXICAL',
    'SPEI_ADAPTATION', 'SP_VISEME_8', 'SP_VISEME_6',
    'SVEWordBoundary', 'SPAUDIOSTATE', 'SPINTERFERENCE_TOOFAST',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPEAudioSizeTime',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SGRSTPropertyValue',
    'DISPID_SRCResume', 'SP_VISEME_21', 'SVP_2',
    'SAFTCCITT_uLaw_11kHzStereo', 'eLEXTYPE_PRIVATE13',
    'DISPID_SpeechGrammarRuleState', 'SpeechSpecialTransitionType',
    'SGRSTTWord', 'SPRULESTATE', 'SVEPrivate',
    'SpeechRegistryLocalMachineRoot', 'SECFNoSpecialChars',
    'SRADynamic', 'SDTAudio', 'DISPID_SPIAudioSizeTime', 'SPAS_STOP',
    'SVSFParseMask', 'SRCS_Disabled', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPRsItem', 'SAFT12kHz16BitMono',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SVP_16', 'STCRemoteServer',
    'SpeechEngineProperties', 'ISpeechXMLRecoResult',
    'DISPID_SRSetPropertyString', 'DISPID_SRCVoicePurgeEvent',
    'SPPS_Function', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SOTsItem', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SPEDisplayText', 'SVSFNLPSpeakPunc',
    'SPINTERFERENCE_NONE', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SMSSetData', 'SpeechGrammarRuleStateTransitionType',
    'eLEXTYPE_PRIVATE10', 'ISpeechRecoContext', 'SPLOADOPTIONS',
    'DISPID_SASCurrentSeekPosition', 'SP_VISEME_16',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SpeechLexiconProns', 'SDTDisplayText',
    'DISPID_SPARecoResult', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPSFunction', 'eLEXTYPE_PRIVATE20', 'SPRECOGNIZERSTATUS',
    'SAFT8kHz16BitMono', 'SpLexicon', 'SDTLexicalForm', 'SPSUnknown',
    'DISPID_SPPValue', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPPS_LMA', 'SREPropertyStringChange', 'SpeechTokenKeyAttributes',
    'ISpRecognizer3', 'ISpeechRecognizerStatus', 'SPWF_SRENGINE',
    'SpeechFormatType', 'DISPID_SPEAudioSizeBytes',
    'SAFTNonStandardFormat',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SASetState',
    'DISPID_SRRTTickCount', 'DISPID_SPAPhraseInfo',
    'DISPID_SRGetRecognizers', 'SPDKL_DefaultLocation', 'SRESoundEnd',
    'SP_VISEME_3', 'SVSFPurgeBeforeSpeak', 'SPDKL_LocalMachine',
    'SpeechPropertyAdaptationOn', 'SpeechAllElements',
    'DISPID_SVGetVoices', 'SVP_19', 'SASClosed', 'SpeechAudioState',
    'DISPID_SWFEChannels', 'SAFT12kHz8BitMono', 'DISPID_SPAs_NewEnum',
    'SAFT12kHz8BitStereo', 'DISPID_SPPId', 'SVEAudioLevel',
    'SDTAlternates', 'DISPID_SLWLangId', 'DISPID_SAFGuid',
    'DISPID_SOTsCount',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPSNotOverriden', 'SPFM_OPEN_READWRITE', 'SAFTADPCM_44kHzMono',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRDisplayUI',
    'DISPID_SOTCGetDataKey', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SECLowConfidence', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SPRuleFirstElement', 'eLEXTYPE_USER_SHORTCUT',
    'SAFT22kHz8BitStereo'
]

_check_version('1.2.1', 1700037012.845771)
